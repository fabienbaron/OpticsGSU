...
imview2(image_spec, direct_obj, caption1="Detector image", caption2="Direct Inversion")
...
imview2(image_spec, wiener_obj, caption1="Detector image", caption2="Wiener Inversion")
